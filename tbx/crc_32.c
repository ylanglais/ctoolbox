...
char crc_32_MODULE[]  = "Posix CRC32 calculator";
char crc_32_PURPOSE[] = "Posix CRC32 calculator";
char crc_32_VERSION[] = "1.1";
char crc_32_DATEVER[] = "30/05/2016";

static unsigned long _posix_crctab[] = {
0x00000000,
...
unsigned long 
crc_32(unsigned char *b, size_t n) {
	/*  Input arguments:
...
main(int n, char *a[]) {
	...
	for (i = 1; i < n; i++) {
		...
		cksum = crc_32((unsigned char *) p, st.st_size);
